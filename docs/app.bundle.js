...
;// CONCATENATED MODULE: ./src/compenents/Navbar.js
var _templateObject;
...
/* harmony default export */ var Navbar = (Narbar);
;// CONCATENATED MODULE: ./src/compenents/GetDate.js
var GetDate_templateObject;
function GetDate_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


// styled-components

var DateStyle = styled_components_browser_esm.div(GetDate_templateObject || (GetDate_templateObject = GetDate_taggedTemplateLiteral(["\n  font-size: 23px;\n  font-family: 'Gowun Dodum', sans-serif;\n\n  display: flex;\n  justify-content: center;\n\n  margin: 40px 0;\n"])));
...
var GetDate = function GetDate() {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(DateStyle, {
    children: ["\uC624\uB298\uC740 ", year, "\uB144 ", month, "\uC6D4 ", date, "\uC77C ", getDay(day), "\uC694\uC77C!"]
  });
};
/* harmony default export */ var compenents_GetDate = (GetDate);
;// CONCATENATED MODULE: ./src/compenents/CreateTodo.js
var CreateTodo_templateObject;
...
function CreateTodo_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var CreateTodo = function CreateTodo() {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(CreateTodoStyle, {
...
/* harmony default export */ var compenents_CreateTodo = (CreateTodo);
;// CONCATENATED MODULE: ./src/compenents/Loading.js
var Loading_templateObject;
function Loading_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


// styled-components

var LoadingStyle = styled_components_browser_esm.div(Loading_templateObject || (Loading_templateObject = Loading_taggedTemplateLiteral(["\n  font-size: 30px;\n\n  display: flex;\n  justify-content: center;\n  align-items: center;\n\n  width: 500px;\n  height: 500px;\n"])));
var Loading = function Loading() {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(LoadingStyle, {
    children: "Loading... \uD83D\uDE22"
  });
};
/* harmony default export */ var compenents_Loading = (Loading);
;// CONCATENATED MODULE: ./src/compenents/TodoList.js
var TodoList_templateObject;
...
function TodoList_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0) { ; } } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function TodoList_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
function TodoList_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var TodoList = function TodoList() {
  ...
  var _useState = (0,react.useState)([]),
    ...
    todos = _useState2[0],
    setTodos = _useState2[1]; // 투두를 가져오는데 필요한 상태
  var _useState3 = (0,react.useState)(true),
    _useState4 = TodoList_slicedToArray(_useState3, 2),
  ...
  (0,react.useEffect)(function () {
    setTimeout(function () {
      fetch('http://localhost:3001/todos').then(function (res) {
        if (!res.ok) {
  ...
  var handleDelete = function handleDelete(id) {
    fetch("http://localhost:3001/todos/".concat(id), {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json'
      }
  ...
  // 투두 완료했니 토글 만들기
  var handleIsComplete = function handleIsComplete(id, isCompleted) {
    var patchData = {
...
/* harmony default export */ var compenents_TodoList = (TodoList);
...
var MainStyle = styled_components_browser_esm.div(Main_templateObject || (Main_templateObject = Main_taggedTemplateLiteral([""])));
var Main = function Main() {
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(MainStyle, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(compenents_GetDate, {
      className: "date"
    }), /*#__PURE__*/(0,jsx_runtime.jsx)(compenents_CreateTodo, {}), /*#__PURE__*/(0,jsx_runtime.jsx)(compenents_TodoList, {})]
  });
};
/* harmony default export */ var pages_Main = (Main);
;// CONCATENATED MODULE: ./src/pages/Author.js
var Author_templateObject;
...
var AuthorStyle = styled_components_browser_esm.div(Author_templateObject || (Author_templateObject = Author_taggedTemplateLiteral(["\n  /* \uC694\uC18C \uC804\uCCB4 \uC911\uC559 \uC815\uB82C */\n  position: absolute;\n  left: 50%;\n  top: 55%;\n  transform: translate(-50%, -50%);\n\n  /* \uC694\uC18C \uAC01\uAC01 \uAC00\uC6B4\uB370 \uC815\uB82C */\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  font-family: 'Gowun Dodum', sans-serif;\n  font-size: 25px;\n  font-weight: 700;\n\n  .author-profile {\n    width: 200px;\n    height: 200px;\n    border-radius: 50%;\n    background-color: #c8bfe7;\n    margin-bottom: 50px;\n  }\n\n  a {\n    &:hover {\n      color: #9f8473;\n    }\n  }\n\n  div {\n    margin-bottom: 20px;\n  }\n"])));

// components
var Author = function Author() {
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(AuthorStyle, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      ...
      children: /*#__PURE__*/(0,jsx_runtime.jsx)("a", {
        href: "https://github.com/dev-sena",
        target: "__blank",
        children: "github: dev-sena"
      })
    })]
  });
};
/* harmony default export */ var pages_Author = (Author);
...
var Wrapper = styled_components_browser_esm.div(App_templateObject || (App_templateObject = App_taggedTemplateLiteral(["\n  height: 92vh;\n\n  background-color: #efe6db;\n  border-radius: 15px;\n  box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;\n\n  /* \uAC00\uC6B4\uB370 \uC815\uB82C */\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform: translate(-50%, -50%);\n"])));
function App() {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(BrowserRouter, {
    children: /*#__PURE__*/(0,jsx_runtime.jsx)(Wrapper, {
      children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        className: "app",
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Navbar, {}), /*#__PURE__*/(0,jsx_runtime.jsxs)(Routes, {
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Route, {
            path: "/",
            element: /*#__PURE__*/(0,jsx_runtime.jsx)(pages_Main, {})
          }), /*#__PURE__*/(0,jsx_runtime.jsx)(Route, {
            path: "/author",
            element: /*#__PURE__*/(0,jsx_runtime.jsx)(pages_Author, {})
          })]
        })]
      })
    })
